...
<template>
  <div class="home">
    ...
    <!-- Search in your movie  -->
    <form @submit.prevent="moveStore.searchMovies">
      <div class="">
        <input type="text" class="" placeholder="search movie" v-model="moveStore.search"/>
      ...
      <div class="movie">
        <router-link to="/movie/tt0078346" class="movie-link">
          <img
            ...
            alt=""
          />
          <div class="movie-type">Actions, Drama, Horor</div>

          <div class="movi-detail">
            <div class="movie-year">1987</div>
            <h3>Superman</h3>
          </div>
        </router-link>
      </div>
